...
import { PlusIcon, Menu, Search, Settings, LogOut, X, User as UserIcon, Loader2 } from "lucide-react";
    ...
    <>
      <header className="bg-white dark:bg-gray-800 z-20 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-full mx-auto px-4 sm:px-6">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    type="button"
                    className="inline-flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-700 shadow-sm px-2 py-2 bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
          ...
          {/* Mobile search bar */}
          {isMobileSearchOpen && (
            <div className="px-2 py-3 md:hidden" ref={searchRef}>
              <Popover open={isSearchPopoverOpen}>
                <PopoverTrigger asChild>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <PopoverContent className="w-[90vw] p-0" align="start">
                  <div className="py-2">
                    {searchResults?.projects?.length === 0 && searchResults?.requirements?.length === 0 ? (
                      <div className="px-4 py-2 text-sm text-gray-500">
                        No results found
