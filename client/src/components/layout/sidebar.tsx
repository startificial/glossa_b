...
export function Sidebar({ isOpen, isCollapsed, toggleCollapse }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 pt-3 pb-4 flex flex-col transform -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out fixed md:sticky top-0 z-20 h-[calc(100vh-61px)]",
          isCollapsed ? "w-16" : "w-64 md:w-72 lg:w-64",
          isOpen && "translate-x-0"
        )}
      >
        {/* This wrapper div is essential - it creates a flex column that fills the height */}
        <div className="flex flex-col h-full">
          ...
          <div className={cn(
            "mt-auto flex-shrink-0 pt-3 md:pt-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800",
