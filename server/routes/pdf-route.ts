 ...
 * 
 * This is a dedicated route for PDF generation that avoids the issues
 * with content-type headers and JSON parsing in our existing routes.
 */
...
router.use('/pdf-files', express.static(documentsDir, {
...
router.post('/generate-simple-pdf', async (req, res) => {
  try {
